...
int main(void) {
    ...
    while (fgets(line, sizeof(line), stdin) != NULL) {
        ...
        bool suppressed = fixture.suppression_after_ms > 0 && keypress_seen &&
                          timestamp - last_keypress < fixture.suppression_after_ms;
        bool idle =
            have_last_frame && timestamp - last_frame >= fixture.config.settings.idle_timeout_ms;
        bool had_pending =
            fixture.state.strategy.sample_count != 0U || fixture.state.strategy.active;
        ...
        int phase = !fixture.config.settings.enabled            ? ZPT_MOTION_GATE_BYPASS
                    : fixture.state.strategy.active             ? ZPT_MOTION_GATE_ACTIVE
                    : fixture.state.strategy.sample_count != 0U ? ZPT_MOTION_GATE_PENDING
        ...
        if (fixture.capture.have_output &&
            ...
            printf("O\t%" PRIu32 "\t%" PRId64 "\t%" PRId64 "\n", timestamp,
                   fixture.capture.output_x, fixture.capture.output_y);
        }
